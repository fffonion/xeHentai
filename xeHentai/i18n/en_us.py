...
TASK_FINISHED = "task #%s download finished"
...
TASK_SLOW = "task #%s is slow, maybe image is too large or connection is too slow, consider use a proxy"
TASK_UNFINISHED = "task #%s remaining these files undownloaded: %s"
...
XEH_SCAN_FAILED = "%s scan page %s failed: %s"
